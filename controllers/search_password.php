<?php 
    ...
    $sql = "SELECT u.USER_PASSWORD,u.USER_NO,u.USER_NAME,e.EMP_FIRST_NAME,e.EMP_LAST_NAME,p.EMP_POS_DESCR,o.ORG_NAME
    ...
    while($row = mysqli_fetch_array($query)) {
        ...
        $result = array("id" => $id,"text" => $username,'position'=>$position,'org'=>$org,'firstname'=>$firstname,'lastname'=>$lastname ,'oldpassword'=>$password);
